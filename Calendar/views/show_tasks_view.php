...
<body>
    <div class="center">
        ...
        <div class="href_cont">
            ...
            <div class="bg">
                <a href="../index.php?action=overdue_tasks" id="2">Просроченные задачи</a>
            </div>
            <div class="bg">
                <a href="../index.php?action=show_completed_tasks" id="3">Выполненные задачи</a>
            </div>
        </div>
        <table cellspacing="0">
            <tbody>
                ...
                <?php foreach ($tasks as $task) : ?>
                    <tr>
                        ...
                        <td class="btns">
                            <a href="../index.php?action=complete_task&id=<?php echo $task['id']; ?>" onclick="return confirm('Вы уверены?')" id="b3">Выполнено</a>
                            <div>|</div>
